        ...
        <div className="mb-7 flex items-center justify-between">
          <div>
            <span className="flex items-center gap-2.5 font-medium text-dark mb-1.5">
              ...
              <EditableText pageSlug="home" sectionKey="new_arrivals" contentKey="new_arrivals_label" contentType="label" value="This Week's" />
            </span>
            <EditableText as="h2" className="font-semibold text-xl xl:text-heading-5 text-dark" pageSlug="home" sectionKey="new_arrivals" contentKey="new_arrivals_title" contentType="title" value="New Arrivals" />
          </div>
          ...
          <EditableButton
            ...
            contentKey="new_arrivals_button"
            label="View All"
